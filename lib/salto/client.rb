module Salto
  class Client
    ...
    def debug(direction, message)
      ...
      message = message.dup.force_encoding(ENCODING) # byte[] bytes = rawString.getBytes(StandardCharsets.UTF_8); String utf8EncodedString = new String(bytes, StandardCharsets.UTF_8);
